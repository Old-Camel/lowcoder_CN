...
// added by mousheng
{
    ...
    "event": {
        ...
        "addTask": "添加任务时",
        "addTaskDesc": "在添加任务时触发",
        "delteMarker": "删除标记时",
        "delteMarkerDesc": "在删除标记时触发",
        "clickMarker": "点击标记时",
    ...
    "uiComp": {
        ...
        "passwordCompKeywords": "mmsrk",
        "richTextEditorCompKeywords": "fwb",
        "numberInputCompKeywords": "szsrk",
        "sliderCompKeywords": "hk",
        "rangeSliderCompKeywords": "fwhk",
        "ratingCompKeywords": "pf",
        "switchCompKeywords": "kg",
        "selectCompKeywords": "xldx",
        "multiSelectCompKeywords": "xldx",
        "cascaderCompKeywords": "jlxz",
        "checkboxCompKeywords": "fx",
        "radioCompKeywords": "dx",
        "segmentedControlCompKeywords": "fdkj",
        "fileUploadCompKeywords": "fj",
        "dateCompKeywords": "rq",
        "dateRangeCompKeywords": "rqfw",
        "timeCompKeywords": "sj",
        "timeRangeCompKeywords": "sjfw",
        "buttonCompKeywords": "an",
        "floatButtonCompName": "悬浮按钮",
        "floatButtonCompDesc": "悬浮按钮组件",
        "floatButtonCompKeywords": "xfan",
        "linkCompKeywords": "lj",
        "scannerCompKeywords": "sm",
        "dropdownCompKeywords": "xlanz",
        "toggleButtonCompKeywords": "qhan",
        "textCompKeywords": "wb",
        "tableCompKeywords": "bg",
        "imageCompKeywords": "tp",
        "progressCompKeywords": "jdt",
        "progressCircleCompKeywords": "yxjdt",
        "fileViewerCompKeywords": "wjck",
        "dividerCompKeywords": "fgx",
        "qrCodeCompKeywords": "ewm",
        "formCompKeywords": "bd",
        "jsonSchemaFormCompKeywords": "jsonbd",
        "containerCompKeywords": "rq",
        "collapsibleContainerCompKeywords": "kzdrq",
        "tabbedContainerCompKeywords": "xxk",
        "modalCompKeywords": "dhk",
        "listViewCompKeywords": "lbst",
        "gridCompKeywords": "wg",
        "navigationCompKeywords": "dh",
        "iframeCompKeywords": "qrwy",
        "customCompKeywords": "zdyzj",
        "moduleCompKeywords": "mk",
        "jsonExplorerCompKeywords": "jsonll",
        "jsonEditorCompKeywords": "jsonbjq",
        "treeCompKeywords": "sxzj",
        "treeSelectCompKeywords": "sxxz",
        "audioCompKeywords": "yp",
        "videoCompKeywords": "sp",
        "drawerCompKeywords": "ct",
        "chartCompKeywords": "tb",
        "carouselCompKeywords": "lbt",
        ...
        "signatureCompKeywords": "qm",
        "jsonLottieCompKeywords": "Lottiedh",
        "responsiveLayoutCompKeywords": "xysbj",
        ...
        "descriptionsName": "描述列表",
        "descriptionsDesc": "用于展示多个只读字段",
        "descriptionsKeywords": "mslb",
    ...
    "meeting": {
        "placement": "会议抽屉位置",
        "cameraViewDesc": "本地用户（主持人）的摄像头视图",
        "screenSharedDesc": "本地用户（主持人）的屏幕共享",
        "audioUnmuted": "音频解除静音",
        "videoOn": "打开视频",
        "top": "顶部",
        "host": "会议室主持人。您需要自己管理主持人的应用逻辑",
        "participants": "会议室参与者",
        "shareScreen": "显示本地用户共享的屏幕",
        "localUserID": "主持人用户 ID",
        "userName": "主持人用户名",
        "rtmToken": "Agora RTM 令牌",
        "rtcToken": "Agora RTC 令牌",
        "right": "右侧",
        "widthTooltip": "像素或百分比，例如 520、60%",
        "openDrawerDesc": "打开抽屉",
        "broadCast": "广播消息",
        "title": "会议标题",
        "videoCompName": "摄像头流",
        "meetingCompDesc": "会议组件",
        "meetingCompKeywords": "Agora 会议，网络会议，协作",
        "userId": "主持人用户 ID",
        "meetingActive": "进行中的会议",
        "messages": "广播的消息"
    },
    "customComp": {
        "data": "要传递给自定义组件的数据",
    ...
    "richTextEditor": {
        "toolbar": "自定义工具栏",
        "toolbarDescription": "您可以自定义工具栏。请参考：https://quilljs.com/docs/modules/toolbar/ 获取更多详细信息。",
        "defaultValue": "默认值"
    },
    "selectInput": {
    ...
    "file": {
        "dataURLDesc": "用于直接将DataURL作为资源嵌入到Image、Icon、avatar等组件中"
    },
    "date": {
        "placeholderText": "占位符"
    },
    ...
    "transformer": {
        "documentationText": "Transformers旨在进行数据转换和重用多行JavaScript代码。使用Transformers将查询或组件的数据适应到本地应用程序的需求。与JavaScript查询不同，transformer设计为执行只读操作，这意味着您无法在transformer内触发查询或更新临时状态。"
    },
    "temporaryState": {
        "documentationText": "低代码中的临时状态是一个强大的功能，用于管理动态更新应用程序中组件状态的复杂变量。这些状态充当数据的中间或瞬时存储，可以由用户交互或其他过程引起的时间变化。"
    },
    "dataResponder": {
        "documentationText": "在开发应用程序时，您可以为组件分配事件以监视特定数据的更改。例如，Table 组件可能具有事件如“行选择更改”、“筛选更改”、“排序更改”和“分页更改”，以跟踪选定行属性的变化。然而，对于临时状态、转换器或查询结果的更改，其中没有标准事件可用，将使用数据响应器。它们使您能够检测和响应任何数据修改。"
    },
    "advanced": {
    ...
    "module": {
        "docLink": "了解更多关于模块的信息...",
        "documentationText": "Lowcoder 模块是完整的应用程序，可以包含并重复在其他 Lowcoder 应用程序中，其功能就像单个组件一样。由于模块可以嵌入，它们需要能够与外部应用程序或网站进行交互。这四个设置有助于支持与模块的通信。"
    },
    "aggregation": {
        "selectedKey": "当前选定的索引"
    },
    "appSetting": {
        ...
        "no": "不允许",
        "PCPadding": "桌面端内边距",
        "PCPaddingDes": "设置桌面端页面容器的内边距",
        "MobilePadding": "移动端内边距",
    ...
    "docUrls": {
        ...
        "eventHandlerSlowdown": "https://moushengkoo.gitee.io/lowcoder_cn/#/event-handler?id=%e9%98%b2%e6%8a%96%e8%8a%82%e6%b5%81",
    ...
    "playground": {
        "url": "https://lowcoder.mousheng.top/playground/{compType}/1"
    },
    "calendar": {
        "events": "事件数据",
        "editable": "可编辑",
    ...
    "timeLine": {
        ...
        "scrollTo": "控制滚动条滚动",
        "pendingDescription": "当设置时，将显示一个带有文本和等待指示器的最后一个节点"
    },
    "comment": {
        "clickedItem": "点击的项目",
        "autoScroll": "自动滚动",
    ...
    "descriptions": {
        ...
        "value": "内容",
        "showbordered": "显示边框",
        "showEditButton": "显示编辑按钮",
        "parseEnter": "解析换行",
        "layout": "布局方式",
        "size": "行大小",
        "columnCount": "每行列数",
        "edit": "编辑",
        "editDesc": "组件无法编辑，但可以激活点击事件"
    },
    "antLayoutComp": {
    ...
    "gantt": {
        ...
        "durationUnit": "持续时间单位",
        "duration": "持续时间",
        "hourScalesFormat": "%M%d日",
        "dayScalesFormat": "%M%d日",
        "weekScalesFormat1": "%M.%d",
        "weekScalesFormat2": "%j日 星期%D",
        "monthScalesFormat1": "%Y年%M",
        "monthScalesFormat2": "第%W周",
        "quarterScalesFormat": "{y}年第{i}季",
        "yearScalesFormat": "%Y年",
        "tree": "可展开",
        "ColumnsData": "列数据",
        ...
        "ColumnsType": "列类型",
        "currentId": "当前操作的ID",
        "currentObject": "当前操作的对象",
        "addTask": "添加任务",
        "taskObject": "任务对象",
        "taskObjectDesc": "支持单个任务或任务数组",
        "removeTask": "删除任务",
        "taskID": "任务ID",
        "taskIDDesc": "数组类型，支持单个或多个ID：如['A2','A3]",
        "linkID": "链接ID",
        "linkIDDesc": "数组类型，支持单个或多个链接ID，如['1','2]",
        "add": "添加",
        "expandingAll": "展开所有",
        "collapsingAll": "折叠所有",
        "addTaskFail": "添加任务失败，参数类型应该为对象或数组对象",
        "addLinkFail": "添加链接失败，参数类型应该为对象或数组对象",
        "removeTaskFail": "删除任务失败，参数类型应该为字符串或字符串数组",
        "removeLinkFail": "删除链接失败，参数类型应该为数组",
        "otherData": "其他数据{i}",
        "projectText": "项目 #{i}",
        "taskText": "任务 #{i}",
        ...
        "progressLowBg": "低进度背景色",
        "progressLowColor": "低进度颜色",
        "progressMediumBg": "中进度背景色",
        "progressMediumColor": "中进度颜色",
        "progressHighBg": "高进度背景色",
        "progressHighColor": "高进度颜色",
        "progresscompletedColor": "进度完成颜色",
    ...
    "amap": {
        "akey": "秘钥",
        "akeyTooltip": "申请秘钥",
        "akeyNote": "请到高德官网申请秘钥，否则组件可能显示为空白",
        "center": "地图中心",
        "centerDes": "地图中心的坐标",
        "zoom": "缩放等级",
        "defaultTitle": "标记数据",
        "allowAddMark": "添加标记",
        "allowAddMarkDes": "点击左键添加标记",
        "allowDelMark": "删除标记",
        "allowDelMarkDes": "点击右键键添加标记",
        "markers": "标记",
        "markersValueDes": "标记数组",
        "centerValueDes": "地图中心坐标",
        "zoomValueDes": "地图缩放等级",
        "Introduction": "数组元素属性介绍",
        "positionDes": "坐标经纬度",
        "titleDes": "标记的标题",
