...
export function mergeObject(obj1: object, obj2: object) {
    var result = {}
    _.merge(result, obj1, obj2);
    return result as Record<string , any>
}

export const en = mergeObject({
...
// added by mousheng
{
  ...
  "event": {
      ...
      "addTask": "Add Task",
      "addTaskDesc": "Triggers on Add Task",
  ...
  "uiComp": {
      ...
      "floatButtonCompKeywords": "float button, action, quick",
      "iconCompName": "Icon",
      "iconCompDesc": "A visual symbol for intuitive representation and enhanced user experience.",
      "iconCompKeywords": "icon, symbol, representation",
      "weekPickerCompName": "Week Picker",
      "weekPickerCompDesc": "Efficiently select weeks with a user-friendly interface.",
      "weekPickerCompKeywords": "week picker, selection, calendar",
      "monthPickerCompName": "Month Picker",
      "monthPickerCompDesc": "Efficiently select months with a user-friendly interface.",
      "monthPickerCompKeywords": "month picker, selection, calendar",
      "quarterPickerCompName": "Quarter Picker",
      "quarterPickerCompDesc": "Efficiently select quarters with a user-friendly interface.",
      "quarterPickerCompKeywords": "quarter picker, selection, calendar",
      "yearPickerCompName": "Year Picker",
      "yearPickerCompDesc": "Efficiently select years with a user-friendly interface.",
      "yearPickerCompKeywords": "year picker, selection, calendar",
      "amapCompName": "AMap",
      "amapCompDesc": "Embeds AMap (Gaode Map) for interactive and customized map integration.",
      "amapCompKeywords": "AMap, Gaode Map, map, integration",
      "avatarCompName": "Avatar",
      "avatarCompDesc": "Displays user avatars or profile images for personalized identification.",
      "avatarCompKeywords": "avatar, profile image, user identification",
      "descriptionsName": "Descriptions",
      "descriptionsDesc": "Organizes information using a flexible and responsive layout with labels and values.",
      "descriptionsKeywords": "descriptions, layout, information organization",
      "antLayoutName": "Ant Layout",
      "antLayoutDesc": "Using Ant Design Layout Components to Quickly Implement a Single Page App.",
      "antLayoutKeywords": "Ant Design, layout, Single Page",
      "ganttName": "Gantt",
      "ganttDesc": "Visualizes project schedules and timelines using an interactive Gantt chart.",
      "ganttKeywords": "Gantt chart, project schedule, timeline visualization",
      "transferName": "Transfer",
      "transferDesc": "Facilitates data transfer between two lists with drag-and-drop functionality.",
      "transferKeywords": "transfer, data, drag-and-drop",
      "cardCompName": "Card",
  ...
  "file": {
      "dataURLDesc": "Used to directly embed DataURL as a resource into components such as Image, Icon, avatar, etc"
  },
  "textShow": {
      "fontStyle": "Font Style",
      "fontSize": "Font Size",
  ...
  "appSetting": {
      ...
      "allowClick": "Allow Click Logo",
      "allowClickDes": "Allow clicking on the logo to return to the homepage",
      "yes": "yes",
      "no": "no",
  ...
  "comment": {
      ...
      "comment1": "What is the use of this component?",
      "comment2": "This component allows you to post or delete comments, as well as mention people who appear in the chat.",
      "comment3": "I want to give it a try",
      "comment4": "Enter the content in the input box below and press shift+enter to send it immediately",
  ...
  "docUrls": {
      ...
      "devNpmPlugin": "https://mousheng.github.io/lowcoder_CN/#/develop-plugins",
      "devNpmPluginText": "如何开发npm插件?",
      "useHost": "https://mousheng.github.io/lowcoder_CN/#/visit-host-api-or-db",
      "eventHandlerSlowdown": "https://mousheng.github.io/lowcoder_CN/#/event-handler?id=%e9%98%b2%e6%8a%96%e8%8a%82%e6%b5%81",
      "thirdLib": "https://mousheng.github.io/lowcoder_CN/#/javascript-in-lowcoder/use-third-party-libraries",
